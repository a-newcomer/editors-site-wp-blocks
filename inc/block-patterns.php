 ...
 * @return void
 */
function foreditors_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'foreditors' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'foreditors' ) ),
		'header'   => array( 'label' => __( 'Headers', 'foreditors' ) ),
		'query'    => array( 'label' => __( 'Query', 'foreditors' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'foreditors' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'foreditors_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'foreditors_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'foreditors/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'foreditors_register_block_patterns', 9 );
